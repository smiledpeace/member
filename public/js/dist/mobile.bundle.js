...
var _vueUtil = __webpack_require__(49);

var _vueUtil2 = _interopRequireDefault(_vueUtil);
...
_vue2.default.use(_vueUtil2.default);
...
var vm = new _vue2.default({
    ...
    created: function created() {
        console.log(1234123);
        _axios2.default.post('/query/queryData', { a: 123 }).then(function (res) {
            console.log(res);
        });
    }
});
...
module.exports = (__webpack_require__(18))(11);
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-11c0ed73", Component.options)
  } else {
    hotAPI.reload("data-v-11c0ed73", Component.options)
  }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-11c0ed73", module.exports)
  }
}
...
var _fn = __webpack_require__(59);
...
var install = function install(Vue) {
  Vue.prototype.$fn = _fn2.default;
};

exports.default = (0, _assign2.default)(util, { install: install });
...
var api = {
    //类型判断
    //数组
    findName: function findName(info, name) {
        var search_key = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'name';

        if (Array.isArray(info)) {
            return info.find(function (item) {
                return item[search_key] === name;
            }) || { value: { value_name: '' } };
        }
        var findkey = (0, _keys2.default)(info).find(function (key) {
            return info[key][search_key] === name;
        });
    ...
    isobject: function isobject(target) {
        return (typeof target === 'undefined' ? 'undefined' : (0, _typeof3.default)(target)) === 'object';
    },

    //键值对象
    isplainobject: function isplainobject(target) {
        return target && api.isobject(target) && (0, _getPrototypeOf2.default)(target) === Object.prototype;
    },

    // 空对象
    isEmptyObject: function isEmptyObject(target) {
    ...
    isInIframe: function isInIframe() {
        try {
            return self.frameElement && self.frameElement.tagName == "IFRAME" || window.frames.length != parent.frames.length || self != top;
        } catch (e) {
            return false;
        }
    },
    ...
    //域名判断
    isdomain: function isdomain(target) {
    ...
    // 获取每年每月对应的天数
    perMonthDays: function perMonthDays(year) {
    ...
    checkTel: function checkTel(tel) {
    ...
    //数字转换为中文大写
    getChineseDigital: function getChineseDigital(num, type) {
        if (!/^\d*(\.\d*)?$/.test(num)) {
    ...
    getNotice: function getNotice(cb) {
     ...
     */
    arrayToObject: function arrayToObject(excel_content_list) {
        if (Object.prototype.toString.call(excel_content_list) != "[object Array]") {
            return excel_content_list;
        }
        var data = {};
        excel_content_list.length && excel_content_list.forEach(function (item) {
...
api.extend(api, {
    //补全自建应用字段数据结构
    copyotherstr4form: function copyotherstr4form(list) {
        if (list) {
            var type = void 0;
            api.each(list, function (field, idx) {
                type = parseInt(field.value.type);
                if (26 === type) {
                    api.each(field.value.table, function (table, idx) {
                        api.copyotherstr4form(table.excel_content_list);
                    });
                } else if (3 === type) {
                    var num = Number(field.value.value);
...
module.exports = (__webpack_require__(18))(15);
